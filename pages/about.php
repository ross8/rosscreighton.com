    ...
    <div class="row">
        <div class="col-xs-10 col-sm-4 col-md-4">
            <div class="tile tile-about">
                <img class='img-responsive' src='./img/about/haiti_lake.png'>
            </div>
        </div>
        <div class="col-xs-10 col-sm-4 col-md-4">
            <div class="tile tile-about">
                <img class='img-responsive' src='./img/about/guitar_basketball.png'>
            </div>
        </div>
        <div class="col-xs-10 col-sm-4 col-md-4">
            <div class="tile tile-about">
                <img class='img-responsive' src='./img/about/grad_barker.png'>
            </div>
        </div>
        <div class="col-xs-10 col-sm-4 col-md-4">
            <div class="tile tile-about">
                <img class='img-responsive' src='./img/about/computer.png'>
            </div>
        </div>
        <div class="col-xs-10 col-sm-4 col-md-4 smaller-hide">
            <div class="tile tile-about">
                <img class='img-responsive' src='./img/about/guitar_haiti.png'>
            </div>
        </div>
    </div>
    <div class="container">
        ...
        <div id="about-text">
            <div class="row">
                <div class="col-sm-20 col-md-20 about-section">
                    <p>It's a little tough to sum up my life thus far in a few short paragraphs, but I'll try to make a long story short. I was born and raised in Greenville, South Carolina...</p>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-sm-20 col-md-20 about-section">
                    ...
                    <p>Another passion in my life is basketball. I devoted endless hours to the sport in high school. I was never much of a star on the court, but the sport taught me invaluable life lessons, the most important of which being how to fail. I still play basketball on a weekly basis; it keeps my head clear and my competitive side alive.</p> 
                </div>
                <div class="col-sm-20 col-md-20 about-section">
            ...
            <div class="row">
                ...
                <div class="col-sm-20 col-md-20 about-section">
                    ...
                    <p>Finally, I'd like to explain a motto of sorts that I have taken on over the years: "Love. Create. Maximize The Pursuit." These are the three things I strive to do every day. I show love to the people in my life. I try to create things, whatever the medium, that make the world a better place. And I try every day to maximize my personal pursuit of happiness.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-20 about-section">
                    <p>If you made it this far, thank you for reading! If you'd like to see some of my work or read through my r&#233;sum&#233;, please explore the rest of my site.</p>
                </div>
            </div>
            <div class="spacer"></div>
        </div>
